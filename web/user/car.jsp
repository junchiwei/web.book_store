...
<div class="container">
    ...
    <div class="contact pull-left top30">
        ...
        <table style="margin-left: 5px; text-align: center" height="30px"
               width="1350px" cellspacing="0px" cellpadding="0px" align="center"
            ...
            <tr bgcolor="#F2E9F0">
                ...
                <td><font style="color: #616161; font-size: 20px;">加入购物车时间</font>
                </td>
                <td colspan="2"><font style="color: #616161; font-size: 20px;">操作</font>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td><a
                        ...
                        style="text-decoration: none">书名：2</a></td>
                <td>1</td>
                <td>1</td>
                <td>1</td>
                <td>1</td>
                <td><a
                        href="settlementOrder.jsp?userId=#&orderId=#&bookId=#"
                        style="text-decoration: none; color: green">结算订单</a>&nbsp;&nbsp; <a
                        href="deleteOrder.jsp?userId=#&carId=#&type=car"
                        style="text-decoration: none; color: red">删除订单</a></td>
            </tr>
